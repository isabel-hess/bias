...
namespace bias {
    ...
    enum ErrorCode 
    {
        ...
        ERROR_SPIN_CHUNKDATA_TIMESTAMP,
        ERROR_SPIN_PROPERTY_NOT_SETTABLE,
        ERROR_SPIN_SET_TRIGGER_EXTERNAL,
        ERROR_SPIN_SET_TRIGGER_INTERNAL,
        ERROR_SPIN_GET_TRIGGER_TYPE,
        ERROR_SPIN_IMAGE_PROCESSOR_CREATE,
        ERROR_SPIN_IMAGE_PROCESSOR_DESTROY,

        // Lucid Arena specific errors
        ERROR_NO_ARENA,
        ERROR_ARENA_OPEN_SYSTEM,
        ERROR_ARENA_CLOSE_SYSTEM,
        ERROR_ARENA_UPDATE_DEVICES,
        ERROR_ARENA_GET_NUM_DEVICES,
        ERROR_ARENA_ENUMERATE_CAMERAS,
        ERROR_ARENA_GET_DEVICE_IP,
        ERROR_ARENA_GET_DEVICE_SERIAL,
        ERROR_ARENA_GET_DEVICE_MODEL,
        ERROR_ARENA_GET_DEVICE_VENDOR,
        ERROR_ARENA_CAMERA_NOT_FOUND,
        ERROR_ARENA_CREATE_DEVICE,
        ERROR_ARENA_DESTROY_DEVICE,
        ERROR_ARENA_GET_NODEMAP,
        ERROR_ARENA_GET_TLSTREAM_NODEMAP,
        ERROR_ARENA_GET_TLDEVICE_NODEMAP,
        ERROR_ARENA_START_CAPTURE,
        ERROR_ARENA_STOP_CAPTURE,
        ERROR_ARENA_GET_BUFFER,
        ERROR_ARENA_REQUEUE_BUFFER,
        ERROR_ARENA_IMAGE_INCOMPLETE,
        ERROR_ARENA_IMAGE_CONVERT,
        ERROR_ARENA_IMAGE_DESTROY,
        ERROR_ARENA_IMAGE_GET_WIDTH,
        ERROR_ARENA_IMAGE_GET_HEIGHT,
        ERROR_ARENA_IMAGE_GET_DATA_PTR,
        ERROR_ARENA_IMAGE_GET_PIXEL_FORMAT,
        ERROR_ARENA_IMAGE_GET_BITS_PER_PIXEL,
        ERROR_ARENA_IMAGE_GET_TIMESTAMP,
        ERROR_ARENA_NO_COMPATIBLE_OPENCV_FORMAT,
        ERROR_ARENA_CONVERT_PIXEL_FORMAT,
        ERROR_ARENA_GET_NODE,
        ERROR_ARENA_GET_NODE_ACCESS_MODE,
        ERROR_ARENA_NODE_NOT_AVAILABLE,
        ERROR_ARENA_NODE_NOT_READABLE,
        ERROR_ARENA_NODE_NOT_WRITABLE,
        ERROR_ARENA_GET_STRING_VALUE,
        ERROR_ARENA_SET_STRING_VALUE,
        ERROR_ARENA_GET_FLOAT_VALUE,
        ERROR_ARENA_SET_FLOAT_VALUE,
        ERROR_ARENA_GET_INTEGER_VALUE,
        ERROR_ARENA_SET_INTEGER_VALUE,
        ERROR_ARENA_GET_BOOLEAN_VALUE,
        ERROR_ARENA_SET_BOOLEAN_VALUE,
        ERROR_ARENA_GET_ENUM_VALUE,
        ERROR_ARENA_SET_ENUM_VALUE,
        ERROR_ARENA_EXECUTE_NODE,
        ERROR_ARENA_PROPERTY_NOT_SETTABLE,
        ERROR_ARENA_SET_TRIGGER_INTERNAL,
        ERROR_ARENA_SET_TRIGGER_EXTERNAL,
        ERROR_ARENA_GET_TRIGGER_TYPE,
